...
export {}
declare global {
  const ApiTimeoutError: typeof import('./composables/useApi')['ApiTimeoutError']
  ...
  const useAppDataManager: typeof import('./composables/useAppDataManager')['useAppDataManager']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { ApiTimeoutError } from './composables/useApi'
